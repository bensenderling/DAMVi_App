function h5_APDM1 = load_h5_APDM3QuaLumbar(file)
% h5_APDM1 = load_h5_APDM1Lumbar(file)
...
for i = 1:length({h5_APDM1.meta.Groups(1).Groups.Name})
    ...
    if strcmp(name, 'Lumbar')
        ...
        h5_APDM1.(name).data.qua = h5read(file, [h5_APDM1.meta.Groups(1).Groups(i).Name '/Orientation'])';
