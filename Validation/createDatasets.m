...
for ii = 1:length(sets)
    ...
    for i = 1:N_files
        ...
        date_File = ['2022010' num2str(i)];
        file{i} = ['C:\Users\bsender\OneDrive - Boston University\BU\Projects\001 BAR\Data\txtExample\example_' sets{ii} '_File_' num2str(i) '_' num2str(i) '_' date_File '.txt'];
