function x_segmented = process_Segment_APDMTurns(x, sel)
% x_segmented = process_Segment_APDMTurns(x, sel)
...
%   subroutine.
% - The method used here will segment time series from APDM Opal sensors
%   using processed turn information from the same data structure. This
%   requires the raw h5 data to be loaded into the BAR App and then merged
%   with its analysis results. As of 12/01/2022 those analysis results are
%   created by running the raw h5 files through executables from APDM.
% Future Work
% - None.
% Dec 2022 - Created by Ben Senderling, bsenderling@unomaha.edu
%% Begin Code
